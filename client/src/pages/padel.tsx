...
export default function PadelPage() {
  const { data: tournaments = [], isLoading } = useQuery<Tournament[]>({
    queryKey: ["/api/tournaments?type=padel"],
  });
    ...
    <div className="min-h-screen">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Padel Tournaments</h1>
                <p className="text-muted-foreground mt-1">
                  Doubles matches with 2 players per team
                </p>
              </div>
            </div>
            <Link href="/create?type=padel">
              <Button size="lg" data-testid="button-create-padel-tournament">
          ...
          <div className="flex items-center gap-2 mb-6 flex-wrap">
            <Badge variant="outline">2 Players per Team</Badge>
            <Badge variant="outline">Singles or Doubles</Badge>
      ...
      <section className="py-8 pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <TournamentList tournaments={tournaments} type="padel" isLoading={isLoading} />
        </div>
      </section>
    </div>
  );
